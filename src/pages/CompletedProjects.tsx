...
const PROJECTS: Project[] = [
  ...
  { id: 19, title: "Cuddalore", subtitle: "Project Completed", state: "Tamil Nadu", desc: "Cuddalore legacy waste project.", project: "Quantity: 98,941 tons. Area reclaimed: 10 acres.", focus: "Project status: Project Completed. Quantity of RDF disposed (tons): 13,551.", outcome: "Category: TN.", metrics: [], waste: 98941, land: 10, co2: 0, beforeImage: p16b, afterImage: p16a },
  { id: 20, title: "Dindigul", subtitle: "Project Completed", state: "Tamil Nadu", desc: "Dindigul legacy waste project.", project: "Quantity: 190,088 tons. Area reclaimed: 10 acres.", focus: "Project status: Project Completed. Quantity of RDF disposed (tons): 14,963.", outcome: "Category: TN.", metrics: [], waste: 190088, land: 10, co2: 0, beforeImage: p22b, afterImage: p22a },
  { id: 21, title: "Perungudi Package-3", subtitle: "Project Completed", state: "Tamil Nadu", desc: "Perungudi Package-3 legacy waste project.", project: "Quantity: 489,150 tons. Area reclaimed: 0 acres.", focus: "Project status: Project Completed. Quantity of RDF disposed (tons): 111,672.", outcome: "Category: TN.", metrics: [], waste: 489150, land: 0, co2: 0, beforeImage: p19b, afterImage: p19a },
  ...
  { id: 24, title: "Trichy", subtitle: "Project Completed", state: "Tamil Nadu", desc: "Trichy legacy waste project.", project: "Quantity: 619,925 tons. Area reclaimed: 38 acres.", focus: "Project status: Project Completed. Quantity of RDF disposed (tons): 97,386.", outcome: "Category: TN.", metrics: [], waste: 619925, land: 38, co2: 0, beforeImage: p23b, afterImage: p23a },
  { id: 25, title: "Trichy New", subtitle: "Project Under Progress", state: "Tamil Nadu", desc: "Trichy New legacy waste project.", project: "Quantity: 289,621 tons. Area reclaimed: 0 acres.", focus: "Project status: Project Under Progress. Quantity of RDF disposed (tons): 95,786.", outcome: "Category: TN.", metrics: [], waste: 289621, land: 0, co2: 0, beforeImage: p24b, afterImage: p24a },
  ...
  { id: 32, title: "Kollam", subtitle: "Project Completed", state: "Kerala", desc: "Kollam legacy waste project.", project: "Quantity: 92,605 tons. Area reclaimed: 4 acres.", focus: "Project status: Project Completed. Quantity of RDF disposed (tons): 13,522.", outcome: "Category: Kerala.", metrics: [], waste: 92605, land: 4, co2: 0, beforeImage: p17b, afterImage: p17a },
  { id: 33, title: "Makkarpura", subtitle: "Project Completed", state: "Gujarat", desc: "Makkarpura legacy waste project.", project: "Quantity: 515,097 tons. Area reclaimed: 2 acres.", focus: "Project status: Project Completed. Quantity of RDF disposed (tons): 105,892.", outcome: "Category: Gujarat.", metrics: [], waste: 515097, land: 2, co2: 0, beforeImage: p25b, afterImage: p25a },
  ...
  { id: 35, title: "Nagpur", subtitle: "Project Completed", state: "Maharashtra", desc: "Nagpur legacy waste project.", project: "Quantity: 1,000,698 tons. Area reclaimed: 53 acres.", focus: "Project status: Project Completed. Quantity of RDF disposed (tons): 88,868.", outcome: "Category: MH.", metrics: [], waste: 1000698, land: 53, co2: 0, beforeImage: p26b, afterImage: p26a },
  ...
  { id: 42, title: "Guwahati", subtitle: "Project Under Progress", state: "Assam", desc: "Guwahati legacy waste project.", project: "Quantity: 410,907 tons. Area reclaimed: 2 acres.", focus: "Project status: Project Under Progress. Quantity of RDF disposed (tons): 117,158.", outcome: "Category: Assam.", metrics: [], waste: 410907, land: 2, co2: 0, beforeImage: p18b, afterImage: p18a },
