  ...
  const slides = [
    {
      ...
      beforeImage: "https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?w=1200&q=80",
      afterImage: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=1200&q=80"
    },
    {
      id: 2,
      number: "2",
      ...
      beforeImage: "https://images.unsplash.com/photo-1530587191325-3db32d826c18?w=1200&q=80",
      afterImage: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1200&q=80"
    },
    {
      id: 3,
      number: "3",
      ...
      beforeImage: "https://images.unsplash.com/photo-1604187351574-c75ca79f5807?w=1200&q=80",
      afterImage: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=1200&q=80"
    }
  ];
        ...
        {slides.map((slide, index) => (
          ...
          >
            <div className="w-full h-full flex flex-col lg:flex-row items-center px-6 lg:px-16 py-12 bg-gray-50">
              ...
              <div className="w-full lg:w-1/2 h-1/2 lg:h-full flex gap-4 items-center justify-center mb-8 lg:mb-0 lg:pr-8">
                {/* Before Image */}
                <div 
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4">
                    <span className="bg-emerald-600 text-white px-4 py-2 rounded-md font-semibold text-sm shadow-lg">
                      Before
                    </span>
                  </div>
                </div>
                ...
                <div 
                  ...
                  style={{
                    ...
                    animation: currentSlide === index ? 'slideInLeft 1s ease-out 0.2s both' : 'none'
                  }}
                >
                  <img
              ...
              {/* Content Section */}
              <div 
                className="w-full lg:w-1/2 lg:pl-8 flex flex-col justify-center"
                style={{
                  animation: currentSlide === index ? 'slideInRight 1s ease-out 0.3s both' : 'none'
                }}
              >
                {/* Number */}
