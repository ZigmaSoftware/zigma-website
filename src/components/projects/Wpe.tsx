...
import pic1 from "@/assets/WPE/1.jpeg";
import pic2 from "@/assets/WPE/2.jpeg";
import pic3 from "@/assets/WPE/3.jpeg";
import pic4 from "@/assets/WPE/4.png";
import pic5 from "@/assets/WPE/5.png";
import pic6 from "@/assets/WPE/6.jpeg";
import pic7 from "@/assets/WPE/7.jpeg";
...
const METRICS: MetricItem[] = [
  {
    ...
    description: "Daily waste plastics extrusion throughput.",
    value: "3,500",
    unit: "TONS / YEAR",
    image: pic1,
  },
  {
    id: "plant-area",
    title: "Plant Area",
    description: "Total plant area for WPE operations.",
    value: "5",
    unit: "ACRES",
    image: pic2,
  },
  {
    ...
    description: "Current workforce engaged at site.",
    value: "50",
    unit: "PEOPLE",
    image: pic3,
  },
  {
    id: "stock-area",
    title: "Stock Area",
    description: "Stock area allocated for processed materials.",
    value: "1",
    unit: "ACRE",
    image: pic4,
  },
...
const FOCUS_SECTIONS: FocusSection[] = [
  {
    id: "yard-view",
    title: "Yard View",
    description: "Overall site and movement area.",
    image: pic1,
    metricId: "plant-area",
  },
  {
    id: "feed-handling",
    title: "Feed Handling",
    description: "Input plastics handling and preparation.",
    image: pic2,
    metricId: "processing-capacity",
  },
  {
    id: "processing-line",
    title: "Processing Line",
    description: "Extrusion line operations in progress.",
    image: pic3,
    metricId: "processing-capacity",
  },
  {
    id: "material-stage",
    title: "Material Stage",
    description: "Intermediate material flow and conversion.",
    image: pic4,
    metricId: "stock-area",
  },
  {
    ...
    description: "On-ground workforce and safety operations.",
    image: pic5,
  ...
  },
  {
    ...
    description: "Recovered material output and stacking.",
    image: pic6,
    metricId: "stock-area",
  },
  {
    ...
    description: "Current execution status at site.",
    image: pic7,
    metricId: "people-employed",
  },
];
...
const Wpe: React.FC = () => {
  ...
  return (
    <article id="waste-plastics-extrusion" className="flex flex-col gap-4">
      <div className="flex text-left gap-2 flex-col md:flex-row md:items-center">
        <h2 className="text-3xl leading-tight text-slate-900 font-bold">Sulur - Coimbatore</h2>
      ...
      >
        <div className="relative min-h-[520px] lg:flex-1 bg-black">
          <div className="absolute inset-0 transition-opacity duration-500 overflow-hidden">
            <img
              src={currentImage}
              alt="Waste plastics extrusion project"
