...
const partners: Partner[] = [
  ...
  { name: "Bharathi Cement Corporation Pvt Ltd", logo: svg1, size: "large" },
  ...
  { name: "Chettinad Cement Corporation Pvt Ltd", logo: chettinadLogo, size: "medium" },
  ...
  { name: "Heidelberg Cement India Limited", logo: zuariLogo, size: "small" },
