...
const ClientMarqueeCard = ({ client }: { client: Client }) => (
  <div className="group relative min-w-[140px] md:min-w-[170px] h-14 md:h-16 bg-card flex  items-center justify-center px-3 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-lg hover:z-10">
    <img
      src={client.logoSrc}
      alt={client.name}
      loading="lazy"
      className="h-20 w-auto max-w-full object-contain opacity-100 transition duration-300 ease-out"
    />
  </div>
);
