...
const CascadeSlider = lazy(() => import("./pages/Cascadeslider"));
const FullScreenSlider = lazy(() => import("./pages/Fullscreenslider"));
const Newsroom = lazy(() => import("./pages/Newsroom"));
const SDGSection = lazy(() => import("./components/home/SdgSection"));
const BluePlanetSection = lazy(() => import("./components/home/BluePlanetSection"));
